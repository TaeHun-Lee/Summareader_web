...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'Summareader.settings')

app = Celery('Summareader')
...
app.conf.beat_schedule = {
    'summarize-every-30-minutes-contrab': {
            'task': 'board.tasks.get_summarized',
